function initHtml() {
    ...
    document.getElementById("toc").insertAdjacentHTML('afterbegin', 
        ...
        + '<hr/>'
        + '<a href="purpose.html#purpose" onclick="toggleMenu()"><h3>Why - The Purpose of the Product</h3>'
        + '<h4>Finding the Key Value Proposition</h4></a>'
        + '<hr/>'
        + '<a href="strategy.html#strategy" onclick="toggleMenu()"><h3>How - Keep Focus in the Right Things</h3>'
        + '<h4>Turning Purpose into Practice with a Sound Strategy</h4></a>'
        + '<hr/>'
        + '<a href="tactics.html#tactics" onclick="toggleMenu()"><h3>What - Building Meaningful Solutions</h3>'
